...
class Poly3(TrajectoryGenerator):
    def __init__(self, start_q, desired_q, T):
        ...
        self.q_k_dot = 0
        self.a_0 = self.q_0
        self.a_1 = self.q_0_dot + 3 * self.q_0
        self.a_2 = 3 * self.q_k - self.q_k_dot
        self.a_3 = self.q_k
    ...
    def generate(self, t):
        ...
        q_dot = self.a_3 * 3 * t**2 + self.a_2 * t * (2 - 3 * t) + self.a_1 * (3 * t**2 - 4 * t + 1) + self.a_0 * (-3) * (t - 1)**2
        q_ddot = self.a_3 * 6 * t + self.a_2 * (2 - 6 * t) + self.a_1 * (6 * t - 4) + self.a_0 * (-6) * (t - 1)
